    ...
    <>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-2 flex-shrink-0">
              ...
              <span className="font-bold text-xl tracking-tight">
                <span className="text-gray-900">Jolli</span>
                <span className="text-[#B91C1C]">Reserve</span>
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <button
                onClick={toggle}
                className="p-2 rounded-full bg-gray-100 border border-gray-200 text-gray-700 hover:bg-gray-200 transition-colors"
              ...
              {user ? (
                <>
                  <span className="px-3 py-1.5 text-sm font-medium text-gray-500 truncate max-w-[150px]">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#B91C1C] text-white text-sm font-medium rounded-full hover:bg-[#991B1B] transition-colors shadow-sm"
                  >
                    Logout
                  </button>
                </>
                ...
                <>
                  <span className="px-3 py-1.5 text-sm font-medium text-gray-500">Guest</span>
                  <Link
                    to="/login"
                    className="px-4 py-2 bg-[#B91C1C] text-white text-sm font-medium rounded-full hover:bg-[#991B1B] transition-colors shadow-sm"
                  >
      ...
      {menuOpen && (
        <>
          ...
          <div
            ref={menuRef}
            className="fixed top-16 left-0 right-0 bg-white border-b border-gray-200 shadow-lg z-50 md:hidden max-h-[calc(100vh-4rem)] overflow-y-auto"
          >
                ...
                {user ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium w-full text-left text-red-700 hover:bg-red-50 transition-colors"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium bg-[#B91C1C] text-white hover:bg-[#991B1B] transition-colors"
                    to="/login"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
