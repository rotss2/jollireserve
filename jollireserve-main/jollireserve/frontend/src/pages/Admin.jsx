        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={s.label} className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 md:p-6">
                <div className="text-xs text-gray-500">{s.label}</div>
                <div className="text-3xl md:text-4xl font-black mt-1 text-gray-900">{s.value ?? "—"}</div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <div key={s.label} className="flex items-center gap-3 p-4 rounded-xl bg-gray-50">
