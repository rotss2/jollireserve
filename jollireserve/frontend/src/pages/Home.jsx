      ...
      <div className="grid md:grid-cols-2 gap-6 items-center">
        <div className="card p-6 md:p-10">
          ...
          <h1 className="text-3xl md:text-5xl font-black leading-tight">
            Delight guests with faster seating and friendlier service.
          </h1>
          <p className="mt-4 text-sm md:text-base" style={{ color: "var(--text-muted)" }}>
            JolliReserve blends a joyful experience with practical staff controls, so every
            table turn feels smooth and every queue update feels clear.
          </p>
